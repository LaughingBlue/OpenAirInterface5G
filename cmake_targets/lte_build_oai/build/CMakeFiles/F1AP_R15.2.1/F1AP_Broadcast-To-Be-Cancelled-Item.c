...
static asn_TYPE_member_t asn_MBR_F1AP_Broadcast_To_Be_Cancelled_Item_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_F1AP_Broadcast_To_Be_Cancelled_Item_specs_1 = {
